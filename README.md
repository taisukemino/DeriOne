...
It'd be useful to get the best option price across options protocols both for investors and developers who want to build on top of an options protocol.

The logical extension of this aggregator would be expanding to other derivatives like swaps, futures and forwards.

In this first version, I kept it minimal. You can get the best ETH put option price from Hegic, Opyn, Auctus by calling a single function.
